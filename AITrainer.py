...
while True:
    ...
    if len(lmList) != 0:
        ...
        per2 = np.interp(angle1, (60, 170), (0, 100))
        per = np.interp(angle, (60, 170), (0, 100))
        bar = np.interp(angle, (30, 170), (0, 100))
        bar2 = np.interp(angle1, (30, 170), (0, 100)) #for right arm (60, 170), (0, 100) is the range of motion
        # print(angle, per)
        #check for curls
        if per == 100:
            if dir == 0:
        ...
        # Progress bar fill
        bar_height = int(np.interp(per, (0, 100), (150, 400)))
        ...
        # Progress bar fill
        bar_height2 = int(np.interp(per2, (0, 100), (150, 400)))
